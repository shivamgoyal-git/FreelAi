...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (!body.professional?.primaryProfession) {
      return NextResponse.json({ error: "Primary Profession is required" }, { status: 400 });
    }
...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    if (body.professional && body.professional.primaryProfession !== undefined && !body.professional.primaryProfession) {
      return NextResponse.json({ error: "Primary Profession cannot be empty" }, { status: 400 });
    }
